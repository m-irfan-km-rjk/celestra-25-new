...
const CompetitionDetails: React.FC = () => {
    ...
    const event = competitions[parseInt(competitionid) || 0] as Competition;
    ...
    const renderRegistrationButton = () => {
        ...
        return (
            <Link href={`/Register/${event.link}?type=competition`}>
                ...
                <div className="bg-gray-800/70 backdrop-blur-lg rounded-2xl p-8 border border-gray-700 shadow-lg">
                    ...
                    <div className="mt-8">
                        ...
                        <ul className="text-gray-400 pl-10">
                            <li>TKMCE Participants: Rs{event.amount[1]}</li>
                            <li>Non-TKMCE Participants: Rs{event.amount[0]}</li>
                        </ul>
                    </div>
